        ...
        <div class="top-bar">
            <div class="topbar-items">
                ...
                <div class="text-item1">
                    <span class="text1">Cosmochics offers Wide Free Delivery </span>
                </div>
                <div class="text-item2">
                    <span class="text2" ><?php echo"Amazing discounts for over 1000 "?></span>
            ...
            <div class="navi-bar-items">
                <div class="categories">
                    ...
                    <div id="mySidepanel" class="sidepanel">
                        ...
                        <h2 style="text-align:center;">Cosmochics</h3>
